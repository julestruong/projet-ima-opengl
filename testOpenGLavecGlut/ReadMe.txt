========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet testOpenGLavecGlut
========================================================================

AppWizard a créé cette application testOpenGLavecGlut pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application testOpenGLavecGlut.


testOpenGLavecGlut.vcxproj
...
testOpenGLavecGlut.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé testOpenGLavecGlut.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
